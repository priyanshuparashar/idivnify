                ...
                <div className="">
                    <div className="row">
                        <div className="col-lg-12 col-md-12 text-center">
                            <h1 className="as_heading">About Astrology</h1>
                            <span>
                            ...
                            <p className="as_font14 as_padderTop20 as_padderBottom50">It is a long established fact that a reader will be distracted by the readable content of a page <br />when looking at its layout. The point of using Lorem Ipsum .</p>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <div className="as_aboutimg text-right">
                                <img src="./src/assets/images/about.jpg" alt="" className="img-responsive" />
                                <span className="as_play"><img src="assets/images/play.png" alt="" /></span>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6">
                            <div className="as_about_detail">
                                ...
                                <div className="as_paragraph_wrapper">
                                    <p className="as_margin0 as_font14 as_padderBottom10">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words.</p>
                                    <p className="as_font14">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium.</p>
                                </div>

                                <div className="as_contact_expert">
                                    <span className="as_icon">
                                        <img src="./src/assets/images/svg/about.svg" alt="" />
                                    </span>
                                ...
                                <a href="about.html" className="as_btn">read more</a>
                            </div>
                        </div>
                    </div>
                </div>
